  ...
  return (
    <>
      <SEO
        title="About"
        path="/about"
        description="About JB Dental Clinic in Makindye, Kampala. Our mission, vision, and commitment to world-class dental care in Uganda. Meet the team behind your smile."
      />
