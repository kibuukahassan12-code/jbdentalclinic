  ...
  return (
    <>
      <SEO
        ...
        path="/services/bridal-dentistry"
        description="Exclusive bridal dentistry in Kampala. The only clinic in Makindye offering wedding-day packages: teeth whitening, smile makeovers, veneers and emergency care for your big day."
      />
      <div className="min-h-screen bg-[#0F0F0F] text-white">
        
        {/* Hero Section - image positioned so woman's full face is visible on the right, text on left */}
        <div className="relative min-h-screen flex items-center justify-center overflow-hidden py-20 lg:py-0">
          <div className="absolute inset-0 z-0 bg-[#0F0F0F]">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-[#0F0F0F] via-[#0F0F0F]/25 to-transparent pointer-events-none" />
            <div className="absolute inset-0 bg-gradient-to-r from-[#0F0F0F] via-[#0F0F0F]/60 to-transparent pointer-events-none" />
          </div>
