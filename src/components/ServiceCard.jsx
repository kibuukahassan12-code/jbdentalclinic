      ...
      <div className="p-6 relative z-10">
        ...
        <div className="flex gap-2">
          ...
          <a
            ...
            className={`flex-1 inline-flex items-center justify-center text-sm font-semibold text-black py-3 rounded-lg transition-all hover:scale-105 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#7FD856] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0F0F0F] ${isExclusive ? 'bg-[#C19A6B] hover:bg-[#D4AF80]' : 'bg-[#7FD856] hover:bg-[#6FC745]'}`}
          >
            Book Now
          </a>
        </div>
