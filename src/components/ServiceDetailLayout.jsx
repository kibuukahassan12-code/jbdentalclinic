  ...
  return (
    <>
      <SEO
        ...
        path={path || `/services/${title.toLowerCase().replace(/\s+/g, '-').replace(/&/g, 'and')}`}
      />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
            ...
            >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center mt-6 font-bold hover:translate-x-2 transition-transform focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#7FD856] rounded"
              >
          ...
          <div className="text-center bg-gradient-to-r from-[#7FD856]/10 via-transparent to-[#7FD856]/10 rounded-3xl p-12 border border-[#7FD856]/20">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="focus:outline-none focus-visible:ring-2 focus-visible:ring-[#7FD856] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0F0F0F] rounded-xl inline-block"
            >
